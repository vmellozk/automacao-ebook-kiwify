...
class KiwifiAutomation():
    ...
    def cadastrar_produto(self,
                          ...
                          descricao='Nao se iluda com esses gurus de internet, aqui voce encontra o melhor do Hacking Brasil. Conteudos atualizados diariamente e exercicios reais propostos. Seja sua propria evolucao!',
    ...
    def adicionar_ebook_ao_produto(self,
        ...
        pyautogui.click(pyautogui.locateCenterOnScreen('essential/aba_editar_produto.png'))
        time.sleep(1)
        ...
        time.sleep(1)
        pyautogui.write(self.nome_produto + ' 1')
        time.sleep(1)
        ...
        pyautogui.write(self.nome_produto + ' ebook')
        time.sleep(3)
        pyautogui.click(pyautogui.locateCenterOnScreen('essential/miniatura_ebook.png'))
        time.sleep(1)
        pyautogui.click(pyautogui.locateCenterOnScreen('essential/abrir.png'))
        time.sleep(6)
        pyautogui.scroll(-1000)
